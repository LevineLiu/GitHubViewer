...
public class RepositoriesEntity implements Parcelable{
     ...
     * updated_at : 2016-04-03T04:00:48Z
    ...
    public RepositoriesEntity() {
    }

    protected RepositoriesEntity(Parcel in) {
        this.id = in.readInt();
    ...
    public static final Creator<RepositoriesEntity> CREATOR = new Creator<RepositoriesEntity>() {
        @Override
        public RepositoriesEntity createFromParcel(Parcel source) {
            return new RepositoriesEntity(source);
        }

        @Override
        public RepositoriesEntity[] newArray(int size) {
            return new RepositoriesEntity[size];
        }
    };
}
