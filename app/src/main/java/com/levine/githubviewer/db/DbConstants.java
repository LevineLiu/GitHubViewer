...
class DbConstants {
    ...
    final static String CREATE_FAVORITE_REPOSITORIES_ENTRY = "CREATE TABLE " + FavoriteNewsEntry.TABLE_NAME_FAVORITE +
            " (" + FavoriteNewsEntry._ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + FavoriteNewsEntry.REPOSITORIES_NAME + " TEXT, " + FavoriteNewsEntry.REPOSITORIES_DESCRIPTION + " TEXT, " +
            FavoriteNewsEntry.REPOSITORIES_LANGUAGE + " TEXT, " + FavoriteNewsEntry.REPOSITORIES_STAR + " INTEGER, " + FavoriteNewsEntry.REPOSITORIES_FORK + " INTEGER)";
